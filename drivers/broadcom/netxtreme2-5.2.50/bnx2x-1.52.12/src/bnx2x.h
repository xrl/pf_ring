...
#define __NO_TPA__		1
#else /* (VMWARE_ESX_DDK_VERSION >= 40000) */
...
#if defined(__VMKLNX__) && defined(__VMKNETDDI_QUEUEOPS__) /* !BNX2X_UPSTREAM */
#define BNX2X_MAX_QUEUES(bp)	((num_queues != 0) ? \
					(IS_E1HMF(bp) ? \
						(MAX_CONTEXT/E1HVN_MAX) : \
						(MAX_CONTEXT)) : \
					(IS_E1HMF(bp) ? (2) : (4)))
#else
...
#define BNX2X_VPD_LRDT_ID_STRING	BNX2X_VPD_LRDT_ID(BNX2X_VPD_LRDT_LIN_ID_STRING)
#define BNX2X_VPD_LRDT_RO_DATA		BNX2X_VPD_LRDT_ID(BNX2X_VPD_LRDT_LIN_RO_DATA)
#define BNX2X_VPD_LRDT_RW_DATA		BNX2X_VPD_LRDT_ID(BNX2X_VPD_LRDT_LIN_RW_DATA)
