...
/* Refers to the bitmap indicating vpath assignment to VFs */
#define VXGE_HW_VPATH_BMAP_START	47
#define VXGE_HW_VPATH_BMAP_END		63
...
#define VXGE_HW_RTS_ACCESS_FW_MEMO_ACTION_NON_PRIV_BANDWIDTH_CTRL	32
#define VXGE_HW_RTS_ACCESS_FW_MEMO_ACTION_PRIV_NWIF	17
#define VXGE_HW_FW_API_CONFIG_RESTORE_DEFAULTS          20
...
#define VXGE_HW_RTS_ACCESS_STEER_DATA0_SEND_MSG_TYPE(val) vxge_vBIT(val, 0, 8)
#define VXGE_HW_RTS_ACCESS_STEER_DATA0_SEND_MSG_DEST(val) vxge_vBIT(val, 8, 8)
#define VXGE_HW_RTS_ACCESS_STEER_DATA0_SEND_MSG_SRC(val) vxge_vBIT(val, 16, 8)
#define VXGE_HW_RTS_ACCESS_STEER_DATA0_SEND_MSG_DATA(val) vxge_vBIT(val, 32, 32)
#define VXGE_HW_RTS_ACCESS_STEER_CTRL_ACTION_SEND_MSG 15

#define VXGE_HW_RTS_ACCESS_STEER_ROM_IMAGE_INDEX(val) vxge_vBIT(val, 16, 8)

#ifdef VXGE_SELF_TEST
/* Fw memo */
#define VXGE_HW_PERFORM_SELF_TEST		9
...
/* Test Params */
#define VXGE_HW_SELF_TEST_LOOP_CNT		1
#define VXGE_HW_SELF_TEST_ERROR			1
#define VXGE_HW_SELF_TEST_CODE			1
#endif
...
/* Catch Basin Mode */
#define VXGE_HW_FW_API_CATCH_BASIN_GRANT	26
#define VXGE_HW_FW_API_CATCH_BASIN_MODE		27
#define VXGE_HW_CATCH_BASIN_MODE_DISABLE	0
#define VXGE_HW_CATCH_BASIN_MODE_ENABLE		1
#define VXGE_HW_CATCH_BASIN_MODE_QUERY		2
...
#define	VXGE_HW_MRPCIM_REG_MODIFIED_MRPCIM_REG_MODIFIED	vxge_mBIT(7)
	...
	u8	unused07350[0x07350-0x07300];

/*0x07350*/     u64	msix_addr;

/*0x07358*/     u64	msix_table;
#define VXGE_HW_MSIX_TABLE_DATA(val)            vxge_vBIT(val, 0, 32)
#define VXGE_HW_WRITE_MSIX_TABLE_MASK           vxge_mBIT(63)

/*0x07360*/     u64	msix_ctl;
#define VXGE_HW_MSIX_CTL_VECTOR_NO(val)         vxge_vBIT(val, 1, 7)
#define VXGE_HW_WRITE_MSIX_CTL_WRITE_OR_READ    vxge_mBIT(15)

/*0x07368*/     u64	msix_access_table;
#define VXGE_HW_WRITE_MSIX_ACCESS_TABLE          vxge_mBIT(0)
...
#define	VXGE_HW_SRPCIM_TO_VPATH_WMSG_SRPCIM_TO_VPATH_WMSG(val) \
							vxge_vBIT(val, 0, 64)
#define VXGE_HW_SRPCIM_TO_VPATH_WMSG_GET_MSG_TYPE(val)  vxge_bVALn(val, 0, 8)
#define VXGE_HW_SRPCIM_TO_VPATH_WMSG_GET_MSG_DST(val)   vxge_bVALn(val, 8, 8)
#define VXGE_HW_SRPCIM_TO_VPATH_WMSG_GET_MSG_SRC(val)   vxge_bVALn(val, 16, 8)
#define VXGE_HW_SRPCIM_TO_VPATH_WMSG_GET_MSG_DATA(val)  vxge_bVALn(val, 32, 32)
